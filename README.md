...
```bash
git clone https://github.com/HospitalCoin/hospital-pool-nodejs.git pool
cd pool
...
The provided config.json file is already set up with most of the information you will need to run a hospital coin pool. Below you will find an explanation of the fields
